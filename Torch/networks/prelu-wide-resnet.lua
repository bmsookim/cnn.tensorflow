...
local function createModel(opt)
   ...
   if opt.dataset == 'imagenet' then
      ...
      print(' | PReLU-Wide-ResNet-' .. depth .. 'x' .. k .. ' ImageNet')
   ...
   elseif opt.dataset == 'catdog' then
      ...
      local n = (depth-4)/6
      local k = opt.widen_factor
      print(' | PReLU-Wide-ResNet-' .. depth .. 'x' .. k .. ' Cat vs Dog')
      local nStages = torch.Tensor{16, 32, 32*k, 64*k, 128*k}
   ...
   elseif opt.dataset == 'cifar10' then
      ...
      local n = (depth-4) / 6
      local k = opt.widen_factor
      print(' | PReLU-Wide-ResNet-' .. depth .. 'x' .. k .. ' CIFAR-10')
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      local n = (depth-4) / 6
      local k = opt.widen_factor
      print(' | PReLU-Wide-ResNet-' .. depth .. 'x' .. k .. ' CIFAR-100')
      local nStages = torch.Tensor{16, 16*k, 32*k, 64*k}
